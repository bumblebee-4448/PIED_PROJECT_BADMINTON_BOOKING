      ...
      <div className="w-full max-w-[450px] md:max-w-4xl lg:max-w-5xl bg-white/95 backdrop-blur-sm rounded-[1.5rem] md:rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,78,67,0.15)] overflow-hidden flex flex-col md:flex-row min-h-[550px] md:min-h-[600px] relative z-10 border border-white/20">
        ...
        <div className="flex-1 p-6 sm:p-10 md:p-12 lg:p-16 flex flex-col justify-center bg-white/50">
          ...
          <form className="space-y-4 md:space-y-5 w-full" onSubmit={(e: React.FormEvent) => e.preventDefault()}>
            <div className="space-y-4">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between ml-1">
                  <Label htmlFor="password" className="text-xs md:text-sm font-bold text-[#374151] uppercase tracking-wider">Mật khẩu</Label>
                  <Link to="/forgot-password" id="forgot-password-link" className="text-xs md:text-sm font-bold text-[#00CE98] hover:text-[#004E43] transition-colors">
                    Quên mật khẩu?
                  </Link>
                </div>
                <div className="relative group">
            ...
            >
              <GoogleIcon />
              <span className="font-bold text-[#374151] text-sm md:text-base">Đăng nhập với Google</span>
            </Button>
            
            <p className="text-center text-[#6B7280] font-medium text-xs md:text-sm pt-2">
              Chưa có tài khoản?{" "}
              <Link to="/register" className="text-[#00CE98] font-bold hover:underline">Tạo tài khoản ngay</Link>
            </p>
          </form>
