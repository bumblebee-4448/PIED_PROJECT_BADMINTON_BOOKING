        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SystemReportId = table.Column<Guid>(type: "uuid", nullable: true),
                    OwnerRequestId = table.Column<Guid>(type: "uuid", nullable: true),
                    FeedbackId = table.Column<Guid>(type: "uuid", nullable: true),
                    WithdrawalId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    FeedbackId1 = table.Column<Guid>(type: "uuid", nullable: true),
                    OwnerRequestId1 = table.Column<Guid>(type: "uuid", nullable: true),
                    ReportId1 = table.Column<Guid>(type: "uuid", nullable: true),
                    SystemReportId1 = table.Column<Guid>(type: "uuid", nullable: true),
                    WithdrawalId1 = table.Column<Guid>(type: "uuid", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
