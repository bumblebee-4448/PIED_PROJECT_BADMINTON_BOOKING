...
public class AppDbContext : DbContext
{
    ...
    // public void Service(IConfiguration configuration)
    // {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<User>(builder =>
        {
            ...
            // {
            //     new() { Id = Guid.NewGuid(), Email = "phamquochoang356@gmail.com", PasswordHash = BCrypt.Net.BCrypt.EnhancedHashPassword("Hoangtm123@" + _securityOptions.Pepper, hashType: BCrypt.Net.HashType.SHA384), Role = "Admin", FirstName = "Phạm", LastName = "Hoàng", PhoneNumber = "0123456781", Status = "Active", CreatedAt = DateTimeOffset.UtcNow, UpdatedAt = DateTimeOffset.UtcNow },
            // });
        });
