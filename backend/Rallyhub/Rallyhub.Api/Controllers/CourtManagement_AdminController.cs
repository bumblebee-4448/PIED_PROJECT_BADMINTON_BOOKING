...
public class CourtManagementAdminController: ControllerBase
{
    private readonly AppDbContext _dbContext;
    private readonly Service.Admin.CourtManagement.IService _adminService;

    public CourtManagementAdminController(AppDbContext dbContext, Service.Admin.CourtManagement.IService adminService)
    {
